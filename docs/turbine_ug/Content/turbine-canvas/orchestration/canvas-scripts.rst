...
#. From the Add panel, drag and drop the **Script**

#. Click **Configure**, then click **Add property** to see a list of
...
#. In the script box, enter a string value or click **select a
...
**Malicious** score threshold, and assigns the result.\ |image2|
