...
Some common use cases for Collaboration Solution include:
...
Collaboration Solution provides for a pathway to request and receive
...
.. toctree::
   ...
   /Content/marketplace/install-and-configure-collaboration-solution
   /Content/marketplace/configure-webhooks
   /Content/marketplace/configure-collaboration-solution-template
