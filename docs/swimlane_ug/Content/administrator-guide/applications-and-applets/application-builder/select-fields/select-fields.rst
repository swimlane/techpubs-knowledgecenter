...
field **Display Name.** Upper-case letters are converted to lower-case,
spaces are replaced with dashes, and non-alphanumeric characters are
removed. You can change the field key value at this time, if desired.
...
.. toctree::
   ...
   /Content/administrator-guide/applications-and-applets/application-builder/select-fields/text
   /Content/administrator-guide/applications-and-applets/application-builder/select-fields/numeric
   /Content/administrator-guide/applications-and-applets/application-builder/select-fields/date-time
   /Content/administrator-guide/applications-and-applets/application-builder/select-fields/selection
   /Content/administrator-guide/applications-and-applets/application-builder/select-fields/users-groups
   /Content/administrator-guide/applications-and-applets/application-builder/select-fields/attachments
   /Content/administrator-guide/applications-and-applets/application-builder/select-fields/reference
   /Content/administrator-guide/applications-and-applets/application-builder/select-fields/comments
   /Content/administrator-guide/applications-and-applets/application-builder/select-fields/widgets
