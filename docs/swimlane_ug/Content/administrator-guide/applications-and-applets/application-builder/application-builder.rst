...
applications. With Swimlane's Application Builder you can:
...
Application Builder is available to any user or administrator of
Swimlane who has permissions set to access applications or a sub-set of
applications.
...
While you build out the forms for your application Swimlane validates
the fields, looking for duplicate fields or empty fields. You will see
...
You can also manually run a validation. From the Application Builder
taskbar menu, select **Validate.**
...
.. |image7| image:: ../../../Resources/Images/validate-application.png

.. toctree::
   :titlesonly:
   :caption: Children:

   /Content/administrator-guide/applications-and-applets/application-builder/define-the-foundation
   /Content/administrator-guide/applications-and-applets/application-builder/create-the-layout
   /Content/administrator-guide/applications-and-applets/application-builder/select-fields/select-fields
   /Content/administrator-guide/applications-and-applets/application-builder/add-applets
   /Content/administrator-guide/applications-and-applets/application-builder/calculation-builder
   /Content/administrator-guide/applications-and-applets/application-builder/view-revision-history
   /Content/administrator-guide/export-templates/export-templates
