...
With Swimlane's Applet Builder you can:
...
You control the view of Applet Builder. Look for the small keyboard icon
in the lower left corner of the applet.
...
While you build out the forms for your applet Swimlane validates the
...
You can also manually run a validation. From the Applet Builder taskbar
...
.. toctree::
   ...
   /Content/administrator-guide/applications-and-applets/applet-builder/build-an-applet
   /Content/administrator-guide/applications-and-applets/applet-builder/applets-and-tasks
   /Content/administrator-guide/applications-and-applets/applet-builder/applets-and-workflow
   /Content/administrator-guide/applications-and-applets/applet-builder/view-revision-history
   /Content/administrator-guide/applications-and-applets/applet-builder/export-applets
   /Content/administrator-guide/applications-and-applets/applet-builder/import-applets
