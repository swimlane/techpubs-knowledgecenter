...
**Important!** Swimlane does not support spinning disks.
...
-  **Ubuntu:** Ubuntu 20.04.6 LTS, 22.04.2 LTS
...
**Note:** If you are using a Layer 4 load balancer for the Swimlane
...
The **Swimlane Platform Installer** and the **Swimlane platform** load
...
**Note:** If you plan to use a separate disk or volume for /var/openebs
