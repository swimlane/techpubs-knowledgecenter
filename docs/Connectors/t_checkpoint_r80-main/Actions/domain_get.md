...
**Description**: Retrieves details of a specific domain in Check Point R80 using the provided unique identifier (UID).

## Endpoint

- **URL:** `/web_api/show-dns-domain`
- **Method:** `POST`
## Inputs
...
[
  {
    "status_code": 200,
    "response_headers": {
      "Date": "Fri, 30 Dec 2022 15:07:33 GMT",
      "Server": "CPWS",
